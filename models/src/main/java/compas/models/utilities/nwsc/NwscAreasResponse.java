 ...
 */
public class NwscAreasResponse {
    private String response_code;
    private Boolean response_status;
    private String response_message;
    private NwscAreasResponseData[] Data;

    //default constrcutor
    public NwscAreasResponse(){}
    ...
    public NwscAreasResponseData[] getData() {
        return Data;
    }

    public void setData(NwscAreasResponseData[] data) {
        Data = data;
    }
}
